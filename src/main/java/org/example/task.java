...
public class task{
    public static void main(String[] args) {
        laptop lap1=new laptop("A5",1234,"Xiaomi");
        lap1.setColor("black");
        lap1.setHDD(256);
        lap1.setOS("Windows");
        lap1.setRAM(8);

        laptop lap2=new laptop("ABC30",5678,"Acer");
        lap2.setColor("white");
        lap2.setHDD(1000);
        lap2.setOS("Windows");
        lap2.setRAM(8);

        laptop lap3=new laptop("AB97",9101,"Dell");
        lap3.setColor("rose");
        lap3.setHDD(500);
        lap3.setOS("Windows");
        lap3.setRAM(16);

        laptop lap4=new laptop("OMAN11",1213,"hp");
        lap4.setColor("black");
        lap4.setHDD(2000);
        lap4.setOS("Linux");
        lap4.setRAM(8);

        laptop lap5=new laptop("MAC101",1415,"Apple");
